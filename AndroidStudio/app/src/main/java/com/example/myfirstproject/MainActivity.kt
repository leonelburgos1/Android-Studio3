...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btregistro = findViewById<ImageButton>(R.id.btregistro)
        val btusuario = findViewById<ImageButton>(R.id.btusuario)
        ...
        button.setOnClickListener {
            ...
            if (peso != null && estatura != null && estatura > 0) {
                ...
                dbHelper.insertarRegistro(fecha, hora, nombre!!, imc, mensaje)
